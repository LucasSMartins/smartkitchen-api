...
from smartkitchen_api.api.routes.cookbook.delete import router as cookbook_delete

# * Importações do RECIPE
from smartkitchen_api.api.routes.cookbook.get import router as cookbook_get
from smartkitchen_api.api.routes.cookbook.post import router as cookbook_post
from smartkitchen_api.api.routes.cookbook.put import router as cookbook_put

# * Importações do PANTRY
from smartkitchen_api.api.routes.pantry.delete import router as pantry_delete
from smartkitchen_api.api.routes.pantry.get import router as pantry_get
from smartkitchen_api.api.routes.pantry.post import router as pantry_post
from smartkitchen_api.api.routes.pantry.put import router as pantry_put

# * Importações do SHOPPING_CART
from smartkitchen_api.api.routes.shopping_cart.delete import (
    router as shopping_cart_delete,
)
from smartkitchen_api.api.routes.shopping_cart.get import (
    router as shopping_cart_get,
)
from smartkitchen_api.api.routes.shopping_cart.post import (
    router as shopping_cart_post,
)
from smartkitchen_api.api.routes.shopping_cart.put import (
    router as shopping_cart_put,
)

# * Importações do TOKEN
from smartkitchen_api.api.routes.token.post import router as token_post

# * Importações do USER
from smartkitchen_api.api.routes.users.delete import router as user_delete
from smartkitchen_api.api.routes.users.get import router as users_get
from smartkitchen_api.api.routes.users.post import router as user_post
from smartkitchen_api.api.routes.users.put import router as user_put
